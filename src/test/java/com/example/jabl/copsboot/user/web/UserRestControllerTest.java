...
import com.example.jabl.copsboot.infraestructure.security.WebSecurityConfiguration;
    ...
    void givenAuthenticatedOfficer_userIsCreated() throws Exception {
        ...
        when(userService.createUser(any(CreateUserParameters.class)))
                .thenReturn(new User(userId,
                        "wim@example.com",
                        new AuthServerId(UUID.fromString("eaa8b8a5-a264-48be-98ded8b4ae2750ac")),
...
"c41536a5a8b9d3f14a7e5472a5322b5e1f76a6e7a9255c2c2e7e0d3a2c5b9d0"
  ...
  """))
                ...
                .andExpect(jsonPath("authServerId").value("eaa8b8a5-a264-48be-98ded8b4ae2750ac"));
    }
